...
def run_pca_separation_from_array(x, fs, k=2, output_dir="output_files", suffix=None):
    """
...
if __name__ == "__main__":
    ...
    run_pca_separation_from_array(x_mixed, sr, k=2, output_dir="output_files", suffix=name)
